...
![主菜单](screenshots/01_menu.png)

游戏启动界面，包含小狐狸吉祥物、金币/体力显示和五大功能入口。

### 关卡地图

![关卡地图](screenshots/02_map.png)

50关蜿蜒路径地图，已通关关卡显示星级评价，当前关卡脉冲发光。

### 游戏界面

![游戏界面](screenshots/03_game.png)

核心9x9棋盘，7种颜色方块，拖拽或点击交换，消除匹配得分。

### 商城系统

![商城](screenshots/04_shop.png)

道具/宝箱/特惠三大分类，金币购买锤子、刷新、+5步、彩色球等道具。

### 每日奖励

![每日奖励](screenshots/05_daily.png)
